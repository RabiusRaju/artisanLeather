...
class SiteContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $values = [
            ...
            'about.story.years_ar'        => '+١٦',
            'about.story.years_label'     => 'Years of Craft',
            'about.story.years_label_ar'  => 'عاماً من الحرفة',
            ...
            // About — Craft Steps
            'about.craft.section_eyebrow' => 'The Process',
            'about.craft.section_eyebrow_ar' => 'العملية',
            'about.craft.section_title'   => 'The Art of Making',
            'about.craft.section_title_ar' => 'فن الصناعة',
            'about.craft.1.num'           => '01',
            'about.craft.1.num_ar'        => '٠١',
            ...
            // About — Materials
            'about.material.section_eyebrow' => 'What We Use',
            'about.material.section_eyebrow_ar' => 'ما نستخدمه',
            'about.material.section_title' => 'Only the Finest Materials',
            'about.material.section_title_ar' => 'أجود الخامات فقط',
            ...
            // About — Values
            'about.value.section_eyebrow' => 'What We Stand For',
            'about.value.section_eyebrow_ar' => 'ما نؤمن به',
            'about.value.section_title'   => 'Our Four Pillars',
            'about.value.section_title_ar' => 'ركائزنا الأربع',
            'about.value.1.number'        => 'I',
            'about.value.1.number_ar'     => '١',
            ...
            // About — Timeline
            'about.timeline.section_eyebrow' => 'Our Journey',
            'about.timeline.section_eyebrow_ar' => 'رحلتنا',
            'about.timeline.section_title' => 'Sixteen Years in the Making',
            'about.timeline.section_title_ar' => 'ستة عشر عاماً من البناء',
            'about.timeline.1.year'       => '2009',
            'about.timeline.1.year_ar'    => '٢٠٠٩',
            ...
            // About — CTA
            'about.cta.eyebrow'           => 'Start Your Journey',
            'about.cta.eyebrow_ar'        => 'ابدأ رحلتك',
            ...
            'about.cta.shop_label'        => 'Shop Collection',
            'about.cta.shop_label_ar'     => 'تسوق المجموعة',
            'about.cta.shop_url'          => '/collections',
            'about.cta.shop_url_ar'       => '/collections?lang=ar',
            'about.cta.contact_label'     => 'Get in Touch',
            'about.cta.contact_label_ar'  => 'تواصل معنا',
            'about.cta.contact_url'       => '/contact',
            'about.cta.contact_url_ar'    => '/contact?lang=ar',
        ];
