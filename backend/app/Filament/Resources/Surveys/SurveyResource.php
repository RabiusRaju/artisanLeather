...
class SurveyResource extends Resource
{
                            ...
                            \Filament\Schemas\Components\Actions::make([
                                Action::make('research_competition_survey')
                                    ...
                                    ->action(function ($get, $set) {
                                        ...
                                        try {
                                            $results = self::fetchCompetitionData($query, $get('_competition_country') ?? 'all', $get('_competition_lang') ?? 'all');
    ...
    private static function fetchCompetitionData(string $query, string $countryFilter = 'all', string $langFilter = 'all'): array
    {
